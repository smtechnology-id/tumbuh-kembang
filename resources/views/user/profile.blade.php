...
<html lang="en">
  ...
  <body class="bg-[#F9FBFD] overflow-x-hidden">
        ...
        <main class="flex-1 pr-[55px] pl-4 py-5">
          <div class="bg-white p-6 rounded-lg shadow-lg">
            <div class="flex items-center justify-between mb-6">
              ...
              <button
                onclick="editProfilData()"
                class="text-[16px] text-red-500 lg:text-[18px] font-semibold"
              >
                Ubah Data
              </button>
            </div>
            <div class="flex items-center mb-6">
              <div class="w-26 h-26 rounded-full overflow-hidden mr-4">
                <img
                  src="{{ asset('assets/images/mommy.webp') }}"
                  alt="Profile Picture"
              ...
              <div>
                <h3 class="text-[24px] font-semibold">{{ Auth::user()->name }}</h3>
                <p class="text-[16px] text-slate-500">{{ Auth::user()->email }}</p>
              </div>
            </div>
            <div>
              <div class="mb-4">
                <label class="block text-gray-600">Nama Lengkap</label>
                <div class="p-2 bg-gray-100 rounded text-gray-800">
                  {{ Auth::user()->name }}
                </div>
              </div>
              <div class="mb-4">
              ...
              <div class="mb-4">
                <label class="block text-gray-600">Kota</label>
                <div class="p-2 bg-gray-100 rounded text-gray-800">
                  Surabaya
                </div>
              </div>
    ...
    <!-- Open Modal -->
    <!-- begin::Edit Data Profil-->
    <div
      id="profil_modal_container"
      class="hidden fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 modal-container">
      <div class="flex w-full h-full justify-center items-center modal-content">
        <form
          id="profil_modal_form"
          class="relative flex flex-col w-full max-w-[600px] py-[26px] px-[18px] min-[840px]:px-[26px] bg-white rounded-xl gap-y-6 min-[840px]:gap-y-8 overflow-y-auto max-h-[80vh]"
        >
          <div class="text-start min-[840px]:text-center p-2">
            <h1
          ...
          <div class="flex flex-col">
            <label for="nama-label" class="ml-1">Foto Profil</label>
            <div
            ...
            >
              <label for="image-upload" style="display: block">
                <img
                  src="{{ asset('assets/images/mom-baby.jpg') }}"
                  alt="Profile Picture"
                  id="profileImage"
                  style="display: block"
                />
              ...
              <div
                class="remove-button"
                onclick="removeImage()"
                style="position: absolute; bottom: 0.3; right: 0"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="22"
            ...
            <p class="text-start mt-2">
              Jenis file yang diperbolehkan: png, jpg, jpeg.
            </p>
          </div>
          <div class="flex flex-col gap-y-5">
            <div class="flex flex-col form-label">
              <label for="nama-label" class="ml-1">Username</label>
              <input
                type="text"
                id="username"
            ...
            <div class="flex flex-col form-label">
              <label for="nama-label" class="ml-1">Email</label>
              <input
                type="text"
                id="email"
                class="text-sm min-[840px]:text-base px-3 py-2 focus:outline-none border border-[#D1D9E2] text-[#474F7C] placeholder:text-[#898989] rounded-lg"
            ...
            <div class="flex flex-col form-label">
              <label for="nama-label" class="ml-1">Tanggal Lahir</label>
              <input
                type="date"
                id="tanggal_lahir"
                class="text-sm min-[840px]:text-base px-3 py-2 focus:outline-none border border-[#D1D9E2] text-[#474F7C] placeholder:text-[#898989] rounded-lg"
            ...
            <div class="form-group m-0">
              <label class="required form-label ml-1">Jenis Kelamin</label>
              <div class="form-check form-check-custom form-check-solid ml-2">
            ...
            <div class="flex flex-col form-label">
              <label for="" class="ml-1">Kota</label>
              <div class="input-group" id="kota">
                <select
                  class="form-select text-sm min-[840px]:text-base px-3 py-2 focus:outline-none border border-[#D1D9E2] text-[#474F7C] placeholder:text-[#898989] rounded-lg w-full"
                >
                  <option>Pilih Kota</option>
                  <option value="1">Surabaya</option>
                  <option value="2">Sidoarjo</option>
                  <option value="3">Gresik</option>
                  <option value="4">Lamongan</option>
                </select>
              </div>
            </div>
          </div>
          ...
          <button
            id="close_profil_modal"
            type="button"
            class="bg-[#0F3F25] px-1.5 min-[840px]:px-2 py-1 absolute top-5 right-4 min-[840px]:right-6 cursor-pointer rounded-full"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
