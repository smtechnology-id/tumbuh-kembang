...
<html lang="en">
    ...
    <head>
        ...
        <!-- Favicon -->
        <link rel="icon" type="image/x-icon" href="assets/icons/icon-LM.png" />
        <!-- Google Font -->
    ...
    <body class="bg-[#F9FBFD] overflow-x-hidden">
                    ...
                    <ul class="flex items-center gap-x-12">
                        <li>
                            <a href="dashboard.html"
                                class="text-white custom-hover">Beranda</a>
                        </li>
                        <li>
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="perkembangan.html"
                                        class="dropdown-item">Skrining
                                        Perkembangan</a>
                                    <a href="gizi-pertumbuhan.html"
                                        class="dropdown-item">Grafik
                                        Pertumbuhan</a>
                                    <a href="imunisasi.html"
                                        class="dropdown-item">Imunisasi</a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <a
                                ...
                                class="text-white custom-hover">Catatan
                                Perkembangan</a>
                        </li>
                    </ul>
                </nav>
                ...
                <div
                    ...
                    <div class="w-full">
                        <ul class="flex flex-col px-4 pt-[80px] gap-y-6">
                            ...
                            <span
                                class="w-[150px] border-t-2 border-[#FFCB40]"></span>
                            ...
                            <li>
                                <a
                                    ...
                                    <img
                                        ...
                                        alt />
                                    <span
                                        class="text-lg font-medium pl-3">Beranda</span>
                                </a>
                            </li>
                            <li>
                                <a
                                    ...
                                    <img
                                        ...
                                        alt />
                                    <span
                                        class="text-lg font-medium pl-3">Skrining
                                        Perkembangan</span>
                                </a>
                            </li>
                            <li>
                                <a
                                    ...
                                    <img
                                        ...
                                        alt />
                                    <span
                                        class="text-lg font-medium pl-3">Grafik
                                        Pertumbuhan</span>
                                </a>
                            </li>
                            <li>
                                <a
                                    ...
                                    <img
                                        class="w-[30px] lg:w-[30px]"
                                        src="{{ asset('assets/icons/vaccines (1).png') }}"
                                        alt />
                                    <span
                                        class="text-lg font-medium pl-3">Imunisasi</span>
                                </a>
                            </li>
                            <li>
                                <a
                                    ...
                                    <img
                                        class="w-[30px] lg:w-[30px]"
                                        src="{{ asset('assets/icons/playtime (1).png') }}"
                                        alt />
                                    <span
                                        class="text-lg font-medium pl-3">Catatan
                                        Perkembangan</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a
                                    ...
                                    <img
                                        ...
                                        alt />
                                    <span
                                        class="text-lg font-medium pl-3">Profil</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a
                                    ...
                                    <img
                                        ...
                                        alt />
                                    <span class="text-lg font-medium pl-3">Data
                                        Anak</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a
                                    href="kata-sandi.html"
                                    class="flex items-center text-white custom-hover">
                                    <img
                                        class="w-[30px] lg:w-[30px]"
                                        src="{{ asset('assets/icons/reset-password.png') }}"
                                        alt />
                                    <span class="text-lg font-medium pl-3">Kata
                                        Sandi</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a
                                    ...
                                    <img
                                        ...
                                        alt />
                                    <span id="modalMobileButton"
                                        class="text-lg font-medium pl-3">Keluar</span>
                                </a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="pt-[88px] pb-12 min-[840px]:pt-[88px] xl:pb-0">
            <div class="flex min-h-screen px-2 py-1">
                <!-- Sidebar -->
                            ...
                            <ul>
                                ...
                                <li class="mb-6">
                                    <a
                                        ...
                                        <!--end::Svg Icon-->
                                        <span
                                            class="text-lg font-medium pl-3">Data
                                            Anak</span>
                                    </a>
                                </li>
                                <li class="mb-6">
                                    <a
                                        ...
                                        <!--end::Svg Icon-->
                                        <span
                                            class="text-lg font-medium pl-3">Kata
                                            Sandi</span>
                                    </a>
                                </li>
                                <li class="mb-6">
                ...
                <!-- Main content -->
                <main class="flex-1 pr-5 pl-4 py-5 max-[850px]:py-3">
                    <div>
                        <h1
                    ...
                    <div class="flex flex-col gap-y-3 py-4">
                        <button
                            onclick="addBabyData()"
                            class="flex flex-col w-full justify-center items-center text-center gap-x-2 bg-[#FFC10E] p-3 rounded-lg outline:none">
                            <span
                                class="text-[#B05F00] font-bold text-[16px] lg:text-[18px]">Tambah
                                Data Anak</span>
                        </button>
                    </div>
                    <div
                        class="mx-auto bg-[#0F3F25] rounded-[16px] gap-y-2 shadow-[2px_2px_8px_2px_rgba(0,0,0,0.20)]">
                        <div
                            class="w-full bg-white items-center text-center rounded-[14px] py-1.5 px-3">
                            <div class="flex items-center justify-between p-2">
                                <div class="flex items-center space-x-4">
                                    <div
                                        class="w-12 h-12 rounded-full flex items-center justify-center">
                                        <img
                                            class="items-center w-[75px] lg:w-[95px]"
                                            src="{{ asset('assets/icons/boy.png') }}"
                                            alt />
                                    </div>
                                    <div class="pl-4">
                                        <h2
                                        ...
                                        <p
                                            class="text-[14px] lg:text-[16px] text-gray-600">
                                            0 tahun 6 bulan
                                        </p>
                                    </div>
                                </div>
                                <button
                                    onclick="editBabyData()"
                                    class="text-red-500 text-[16px] lg:text-[18px] font-semibold">
                                    Ubah Data
                                </button>
                            </div>
                        </div>
                        ...
                        <div
                            class="py-6 flex flex-col w-full gap-y-[20px] xl:gap-y-[20px] min-[1600px]:gap-y-[20px]">
                            <div class="flex flex-col px-[35px]">
                                <div
                                    class="flex flex-row min-[840px]:flex-row flex-between gap-x-[25px] gap-y-[20px]">
                                    <a href="#" class="w-full hover:not">
                                        <div
                                            class="flex flex-col w-full bg-white p-[32px] rounded-2xl gap-y-3 shadow-[0_2px_4px_0px_rgba(0,0,0,0.10)]">
                                            <img
                                                src="{{ asset('assets/icons/imunisasi.png') }}"
                                                alt="Icon suntik"
                                                class="h-[40px] object-contain" />
                                            <div
                                                class="flex flex-col justify-center text-center">
                                                <span
                                                    style="color: black">Imunisasi</span>
                                                <div
                                                    class="w-full flex justify-center items-end gap-1 text-black">
                                                    <h1
                                                        class="tinggi__badan text-2xl font-bold">-</h1>
                                                    <span
                                                        class="text-lg font-bold">/45</span>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                    <a href="#" class="w-full block">
                                        <div
                                            class="flex flex-col w-full bg-white p-[32px] rounded-2xl gap-y-3 shadow-[0_2px_4px_0px_rgba(0,0,0,0.10)]">
                                            <img
                                                src="{{ asset('assets/icons/status-gizi.png') }}"
                                                alt="Nutrisi"
                                                class="h-[40px] object-contain" />
                                            <div
                                                class="flex flex-col justify-center text-center">
                                                <span
                                                    style="color: black">Statuz
                                                    Gizi</span>
                                                <div
                                                    class="w-full flex justify-center items-end gap-1 text-[#6BD147]">
                                                    <h1
                                                        class="lingkar__kepala text-2xl font-bold">
                                                        Gizi Baik
                                                    </h1>
                                                </div>
                                            </div>
        ...
        <!-- Open Modal -->
        <!-- begin::Tambah Data Anak-->
        <div
            id="add_modal_container"
            class="hidden fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 modal-container">
            <div
                class="flex w-full h-full justify-center items-center modal-content">
                <form
                    id="add_modal_form"
                    class="relative flex flex-col w-full max-w-[600px] py-[20px] px-[18px] min-[840px]:px-[26px] bg-white rounded-xl gap-y-6 min-[840px]:gap-y-8 overflow-y-auto max-h-[80vh]"
                    action="{{ route('user.add.data-anak') }}"
                    method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="text-start min-[840px]:text-center">
                        <h1
                            class="font-bold text-[22px] min-[840px]:text-[24px] text-[#0F3F25]">
                            Tambah Data Anak
                        </h1>
                        <p class="text-xs min-[840px]:text-sm text-[#898989]">
                    ...
                    <div class="flex flex-col gap-y-5">
                        <input
                            ...
                            id="nama"
                            name="nama"
                            class="text-sm min-[840px]:text-base px-3 py-2 focus:outline-none border border-[#D1D9E2] text-[#474F7C] placeholder:text-[#898989] rounded-lg"
                            placeholder="Nama Lengkap"
                            required />
                        <div class="flex flex-col form-label ml-1">
                            <label for="nama-label" class="ml-1">Tanggal
                                Lahir</label>
                            <input
                                type="date"
                                id="tanggal_lahir"
                        ...
                        <div class="form-group m-0 p-0 ml-1">
                            <label class="required form-label">Jenis
                                Kelamin</label>
                            <div
                                class="form-check form-check-custom form-check-solid ml-2">
                        ...
                        <input
                            ...
                            class="text-sm min-[840px]:text-base px-3 py-2 focus:outline-none border border-[#D1D9E2] text-[#474F7C] placeholder:text-[#898989] rounded-lg"
                            pattern="^[0-9]*\.?[0-9]*$"
                            placeholder="Berat Badan (kg) cth: (2.55)"
                            required />
                        <input
                            type="text"
                            id="tinggi"
                            ...
                            class="text-sm min-[840px]:text-base px-3 py-2 focus:outline-none border border-[#D1D9E2] text-[#474F7C] placeholder:text-[#898989] rounded-lg"
                            pattern="^[0-9]*\.?[0-9]*$"
                            placeholder="Tinggi Badan (cm) cth: (6.2)"
                            required />
                    </div>
                    <button
                        id="sweetalert_simpan"
                        type="submit"
                        class="w-full bg-[#0F3F25] px-2 py-2.5 text-white rounded-lg text-sm min-[840px]:text-base">
                        Simpan
                    </button>
                    ...
                    <button
                        id="close_add_modal"
                        type="button"
                        class="bg-[#0F3F25] px-1.5 min-[840px]:px-2 py-1 absolute top-4 right-4 min-[840px]:right-6 cursor-pointer rounded-full">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="w-4 min-[840px]:w-5 fill-white"
                            viewBox="0 0 384 512">
                            <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                            <path
                                d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" />
        ...
        <!-- end::Tambah Data Anak -->

        <!-- begin::Edit Data Anak-->
        <div
        ...
        <div
            ...
            <div
                ...
                <div class="flex justify-center gap-4 w-full">
                    <button
                        id="cancelLogout"
                        class="bg-gray-300 text-white px-4 py-2 rounded-lg w-1/2 hover:bg-[#FFA800] focus:outline-none">
                        Batal
                    </button>
                    <button
                        id="confirmLogoutButton"
                        class="bg-[#0F3F25] text-white px-4 py-2 rounded-lg w-1/2 hover:bg-[#FFA800] focus:outline-none">
                        Keluar
                    </button>
                </div>
            </div>
            ...
            <div
                ...
                <div class="w-full flex flex-col gap-y-5">
                    ...
                    <div class="order-2 flex flex-col ml-1">
                        <span class="text-sm lg:text-base text-white">Langkah
                            Maju hadir untuk memberikan pendampingan yang
                            optimal
                            dalam setiap fase pertumbuhan anak,
                        </span>
                        <span class="text-sm lg:text-base text-white">sehingga
                ...
                <div class="w-full pt-4 border-t border-[#D1D9E2]">
                    <span class="text-[12px] lg:text-sm text-white">© Copyright
                        2023
                    </span>
                </div>
            </div>
        ...
        <script src="{{ asset('assets/js/data-anak.js') }}"></script>
